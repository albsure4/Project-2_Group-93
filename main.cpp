...
std::cout << "Please select a country by typing the corresponding number:\n";
...
std::vector<dataEntries> trending; //create vector of class objects where an object is a singular trending video
...
std::cout << title << std::endl;
    ...
    trending.push_back(trendingVideo);
}
